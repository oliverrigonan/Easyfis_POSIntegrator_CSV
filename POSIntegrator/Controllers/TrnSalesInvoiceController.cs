    ...
    class TrnSalesInvoiceController
    {
        ...
        public void SendSalesInvoiceCSVFile(String apiUrlHost)
        {
            try
            {
                ...
                // Stock In File Paths
                // ===================
                String stockInItemFilesPath = "d:/innosoft/csv/IN/items";
                List<String> stockInItemFilesh = new List<String>(Directory.EnumerateFiles(stockInItemFilesPath));

                if (!stockInItemFilesh.Any())
                {
                    // ==========
                    // File Paths
                    // ==========
